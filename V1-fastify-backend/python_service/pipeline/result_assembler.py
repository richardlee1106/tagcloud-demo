...
def build_region_views(*, cluster_entries: List[Dict[str, Any]]) -> Dict[str, List[Dict[str, Any]]]:
    ...
    for entry in cluster_entries:
        ...
        canonical_region = {
            ...
            "dominant_secondary_categories": entry.get("dominant_secondary_categories", entry["dominant_categories"]),
            "dominant_primary_categories": entry.get("dominant_primary_categories", []),
            "livelihood_profile": entry.get("livelihood_profile"),
        ...
        fuzzy_regions.append(
            {
                ...
                "dominantSecondaryCategories": entry.get("dominant_secondary_categories", entry["dominant_categories"]),
                "dominantPrimaryCategories": entry.get("dominant_primary_categories", []),
                "livelihoodProfile": entry.get("livelihood_profile"),
