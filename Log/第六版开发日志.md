...
| 文件路径                          | 修改内容                                                  |
| --------------------------------- | --------------------------------------------------------- |
| `src/components/TagCloud.vue`     | Ȩ propsJenks ࡢɫӳ䡢ͼcoordKey ƥ |
...
- **ԭ**ӿڲü `cullingViewport` ĳعбƳôδͬɾ
- **解决**：注释掉 Zoom 回调中的 `cullingViewport(width, height)` 调用。

###  2ǩƲɫĬ

- ****Ȩغǩȷɫ/קɫָΪĬɫ
- **ԭ**`updateHighlight` δʹȨɫ߼ͣ״̬仯ʱзǸǩΪ `#bfeaf1`
...
- ****Ԥ׶νȨֵӵ `displayName`ʹ Worker ȷıȡ
