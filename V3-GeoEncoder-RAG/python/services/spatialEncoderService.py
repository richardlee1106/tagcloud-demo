...
POI_CHECKPOINT_PATH = PROJECT_ROOT / 'spatial_encoder' / 'v26_GLM' / 'saved_models' / 'poi_encoder' / 'best_model.pt'
TOWN_CHECKPOINT_PATH = PROJECT_ROOT / 'spatial_encoder' / 'v26_GLM' / 'saved_models' / 'town_encoder' / 'best_model.pt'
POI_FEATURE_CACHE_PATH = PROJECT_ROOT / 'V3-GeoEncoder-RAG' / 'cache' / 'poi_feature_cache_v1.npz'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='V3 Dual Spatial Encoder Service')
    ...
    print('=' * 60)
    print('V3 Dual Spatial Encoder Service')
    print('=' * 60)
